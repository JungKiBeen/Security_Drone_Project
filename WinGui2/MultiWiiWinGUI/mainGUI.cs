...
namespace MultiWiiWinGUI
{
    ...
    public partial class mainGUI : Form
    {
        ...
        /*  <변수 설명>
         *   DataGridView missionDataGrid : waypoint(WP)의 데이터를 가지고 있다.
         *   int selectedrow : GUI 상에서 add waypoint 버튼 클리 시 추가된 WAYPOINT의 인덱스를 가지고 있다.
         */
        ...
        private void nWPRadius_ValueChanged(object sender, EventArgs e)
        {
